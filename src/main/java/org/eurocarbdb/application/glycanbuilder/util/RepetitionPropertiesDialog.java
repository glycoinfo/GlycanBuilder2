...
public class RepetitionPropertiesDialog extends EscapeDialog implements java.awt.event.ActionListener, java.awt.event.ItemListener  {
	...
	private void setSelections() {
		field_LinkageType_head.setSelectedItem(current.getParentLinkage().getParentLinkageType());
	}
		...
		try {
    		...
    		for(LinkageType a : LinkageType.values()) {
    			if(a.toString().equals(a_sLinkageType_head)) {
    				current.getParentLinkage().setParentLinkageType(a);
    			}
    		}
    	} catch (Exception e) {
    		e.printStackTrace();
						...
						.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								...
								.add(layout.createSequentialGroup()
										...
										.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												...
												.add(field_LinkageType_head, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 74, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
						.addContainerGap())
				);
